...
MILES=[
 ...
 {"y":"2025","t_es":"Sexta Cumbre del Agua para los Pueblos","t_en":"Sixth Water Summit for the Peoples",
  "x_es":"En octubre de 2025, Fundación Puna participó de la Sexta Cumbre Plurinacional del Agua para los Pueblos del Abya Yala, en San Pedro de Atacama (Chile). Desde muy temprano, comunidades y delegaciones de todo el continente se reunieron en una jornada de reflexión, intercambio de saberes y defensa del agua y los territorios. Tras la ceremonia de apertura, el mapeo colectivo de los conflictos hídricos y socioambientales permitió visibilizar realidades compartidas entre distintos pueblos, y el taller de monitoreo comunitario del agua —a cargo de la Unidad de Medio Ambiente del Consejo de Pueblos Atacameños— fortaleció la capacidad de las comunidades para generar sus propios datos y proteger sus fuentes. Por la tarde, las mesas de trabajo abordaron los grandes desafíos de la región —megaminería, hidrocarburos, hidrógeno verde y zonas de sacrificio; agronegocios, soberanía alimentaria y salud comunitaria; justicia ambiental y derechos de la naturaleza—, y el encuentro cerró con una plenaria de conclusiones y propuestas comunes para seguir tejiendo una red plurinacional en defensa del agua.",
  "x_en":"In October 2025, Fundación Puna took part in the Sixth Plurinational Water Summit for the Peoples of Abya Yala, in San Pedro de Atacama (Chile). From early morning, communities and delegations from across the continent gathered for a day of reflection, exchange of knowledge and defense of water and territory. After the opening ceremony, a collective mapping of water and socio-environmental conflicts made shared realities across peoples visible, and a community water-monitoring workshop —led by the Environment Unit of the Council of Atacameño Peoples— strengthened communities' capacity to generate their own data and protect their water sources. In the afternoon, thematic working tables took on the region's great challenges —mega-mining, hydrocarbons, green hydrogen and sacrifice zones; agribusiness, food sovereignty and community health; environmental justice and the rights of nature— and the summit closed with a plenary of shared conclusions and proposals to keep weaving a plurinational network in defense of water.",
  "ph":[]},
...
LINKS={
 "Sexta Cumbre del Agua para los Pueblos":[
   {"es":"Síntesis de la Sexta Cumbre del Agua para los Pueblos del Abya Yala","en":"Summary of the Sixth Water Summit for the Peoples of Abya Yala","src":"infoterritorial.com.ar","url":"https://infoterritorial.com.ar/sintesis-de-la-sexta-cumbre-del-agua-para-los-pueblos-del-abya-yala/"}],
 "Cumbre del Agua":[
