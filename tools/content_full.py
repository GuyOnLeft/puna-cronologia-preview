...
MILES=[
 ...
 {"y":"2025","t_es":"Sexta Cumbre del Agua para los Pueblos","t_en":"Sixth Water Summit for the Peoples",
  "x_es":"En octubre de 2025, Fundación Puna participó de la Sexta Cumbre del Agua para los Pueblos del Abya Yala, realizada en San Pedro de Atacama (Chile). El encuentro reunió a comunidades originarias, especialistas y activistas de la región para compartir estrategias en defensa del agua y del territorio frente al avance de las políticas extractivas.",
  "x_en":"In October 2025, Fundación Puna took part in the Sixth Water Summit for the Peoples of Abya Yala, held in San Pedro de Atacama (Chile). The gathering brought together Indigenous communities, specialists and activists from across the region to share strategies in defense of water and territory against the advance of extractive policies.",
  "ph":[]},
